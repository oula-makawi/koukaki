...
<div id="page" class="site">
    ...
    <ul>
        <li class="site-title">
            <a href="<?php echo esc_url(get_site_url()); ?>" rel="home">Fleurs d'oranger & chats errants</a>
        </li>
    </ul>
    ...
    <div id="modal" class="modal" aria-controls="primary-menu" aria-expanded="false">
        ...
        <div class="modal__content">
            <img class="modal__content--logo" src="<?php echo esc_url(get_theme_file_uri('/assets/images/logo.png')); ?>" alt="Logo">
